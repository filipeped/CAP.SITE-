...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  const ALLOWED_ORIGINS = [
    ...
    "https://cap.digitalpaisagismo.site",
    "https://atendimento.digitalpaisagismo.site",
    "http://localhost:3000"
  ];
  const origin = req.headers.origin;
  res.setHeader("Access-Control-Allow-Origin", ALLOWED_ORIGINS.includes(origin) ? origin : "https://www.digitalpaisagismo.site");
